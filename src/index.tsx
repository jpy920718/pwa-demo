...
// Learn more about service workers: https:/ffdfdf/cr3333a.link/PWA
// unregister() to register() belowdfdfd. Note333 thifffdfds comes with s33ome pitfalls.
...
// if(!navigator.onLine){
//   new Notification('提示', {body: '当前网络22333已断开'})
// }
